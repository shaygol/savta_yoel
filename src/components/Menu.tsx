          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
            {filteredProducts?.map((product, index) => {
              ...
              return (
                <div
                  key={product.id}
                  className="bg-card rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 animate-fade-in group cursor-pointer"
                      ...
                      <div onClick={e => e.stopPropagation()}>
                        {quantity === 0 ? (
                          ...
                          <Button
                            ...
                            aria-label={`הפחת כמות ${product.name}`}
                          >
                          ...
                          <Button
                            ...
                            aria-label={`הוסף עוד ${product.name}`}
                          >
